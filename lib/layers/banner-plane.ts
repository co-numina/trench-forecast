...
// Plane faces right →, banner attaches at row 2 (the --- rope row)
// Reference layout from text banner.txt:
//                           __
//                  __      /  /
//   ---[ ... ]--- / /___  /**/
//                /_/^^+*#####*X
...
const BANNER_ROW = 2; // row within PLANE where banner rope attaches
